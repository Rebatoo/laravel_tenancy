...
<head>
    ...
    <title>LaundryHub - Your Trusted Laundry Service</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <img src="{{ asset('images/logo.png') }}" alt="LaundryHub Logo" class="h-12 w-auto mr-2">
                    <h1 class="text-2xl font-bold text-blue-600">LaundryHub</h1>
                </div>
    ...
    Tenant Domain: http://laundry.localhost:8000/
    <br>
    admin: 
    <br>
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            ...
                            <span class="block text-blue-600">Laundry Services</span>
                        </h1>
            ...
            <div class="mt-10">
                <div class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">Premium Cleaning</h3>
                            <p class="mt-2 text-base text-gray-500">
                                We use high-quality detergents and advanced cleaning techniques to ensure your clothes look their best.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <p class="mt-2 text-base text-gray-500">
                                Get your clothes back clean and fresh within 24 hours. We value your time.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <p class="mt-2 text-base text-gray-500">
                                Enjoy affordable rates without compromising on quality. We offer various packages to suit your needs.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <p class="mt-2 text-base text-gray-500">
                                Book your laundry service online with just a few clicks. Track your order status in real-time.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <p class="text-base text-gray-400">
                    &copy; 2024 LaundryHub. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
